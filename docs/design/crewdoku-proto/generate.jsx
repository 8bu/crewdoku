            ...
            <Panel title="Review proposal">
              <div className="space-y-2">
                <p className="text-2xs text-dim leading-snug">
                  Click violet cells on the board to decide individually, or use bulk actions.
                </p>
                <div className="flex items-center gap-1.5">
                  <div className="flex-1 h-1 bg-[var(--surface-2)] rounded-[1px] overflow-hidden">
                    <div className="h-full rounded-[1px] transition-all duration-300"
                      style={{
                        width: (decidedCount / p.changes.length * 100) + "%",
                        background: "var(--st-prop)",
                      }} />
                  </div>
                  <span className="font-mono text-2xs text-dim tabular-nums shrink-0">
                    {decidedCount}/{p.changes.length}
                  </span>
                </div>
                <div className="flex gap-1.5">
                  <Btn className="flex-1 justify-center"
                    onClick={() => dispatch({ type: "DIFF_ALL", decision: "accept" })}>
                    Accept all
                  </Btn>
                  <Btn className="flex-1 justify-center"
                    onClick={() => dispatch({ type: "DIFF_ALL", decision: "reject" })}>
                    Reject all
                  </Btn>
                </div>
                <div className="flex gap-1.5">
