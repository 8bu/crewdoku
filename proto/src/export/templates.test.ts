...
describe('export templates', () => {
  ...
  const people: Person[] = [
    ...
    { id: 'p2', name: 'Bob', teamId: 't1', rotationOffset: 0, ineligible: [] },
    { id: 'p3', name: 'Charlie', teamId: 't2', rotationOffset: 0, ineligible: [] },
    { id: 'p4', name: 'Dan', teamId: UNASSIGNED_TEAM_ID, rotationOffset: 0, ineligible: [] },
    { id: 'p5', name: 'Eve', teamId: 'unresolved_team', rotationOffset: 0, ineligible: [] },
    { id: 'p6', name: 'Frank', teamId: 't1', rotationOffset: 0, ineligible: [], removed: true },
  ]
