...
import type { CoverageBand, CoverageTable as CoverageTableData } from '../../state/coverageRules'
...
export function CoverageTable({
  ...
  return (
    <section className="flex flex-col gap-3">
      <div>
        <h2 className="m-0 text-sm font-semibold tracking-tight text-base-content">Coverage</h2>
      ...
      <div className="flex flex-col gap-2">
        <h3 className="m-0 text-2xs font-semibold uppercase tracking-wide text-base-content/40">Date overrides</h3>
        {overrideDates.length === 0 && <p className="text-xs text-base-content/40">None — every date follows its weekday row above.</p>}
        ...
        <div className="flex items-end gap-2">
          <div className="flex flex-col gap-1">
            <label className="text-2xs font-semibold uppercase tracking-wide text-base-content/40">Add override for</label>
            <input
              type="date"
